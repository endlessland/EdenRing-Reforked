...
public class EdenRecipes {
	...
	public static void init() {
		...
		BCLRecipeBuilder.crafting(EdenRing.makeID("gravilite_shards"), EdenBlocks.GRAVILITE_SHARDS).shapeless().addMaterial('#', EdenBlocks.GRAVILITE_BLOCK).setOutputCount(4).build();
		...
		BCLRecipeBuilder.crafting(EdenRing.makeID("yellow_dye"), Items.YELLOW_DYE).shapeless().addMaterial('#', EdenBlocks.GOLDEN_GRASS).build();
		BCLRecipeBuilder.crafting(EdenRing.makeID("magenta_dye"), Items.MAGENTA_DYE).shapeless().addMaterial('#', EdenBlocks.VIOLUM).build();
