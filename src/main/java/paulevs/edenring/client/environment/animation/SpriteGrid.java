...
public class SpriteGrid {
	...
	private final List<List<ChunkPos>> missingChunks = new ArrayList<List<ChunkPos>>(2);
	...
	public SpriteGrid(SpriteInitializer initializer, BiomeCountProvider spriteCount) {
		...
		missingChunks.add(new ArrayList<ChunkPos>(1024));
		missingChunks.add(new ArrayList<ChunkPos>(1024));
	}
